...
Чтобы в настройках в пункте "Устройство вывода звука" вместо "Дефаюлт Девице", отображалось "По умолчанию", то добавьте в файл `C:\Games\Reloaded\Mods\p3ppc.text.russianTranslation\InabaPatches\weird_crap.expatch` (открывать в блокноте) строку index=3 в блок указанный ниже:
```
[replacement Default Device]
search = "Default Device"
replacement = "Po ymolhaniu"
padNull=true
offset=0
index=3
```
